<template>
  <main class="wrap lg:grid lg:grid-cols-2 relative lg:gap-6">
    ...
    <div
      class="lg:w-1/2 absolute lg:h-full text-center duration-1000 h-1/2 w-full z-10"
      :class="{
    ...
    <form
      class="text-2xl flex flex-col justify-between pb-6 lg:pb-0"
      @submit.prevent="() => inputReset('register')"
    >
      <h1 class="text-3xl text-brand-02 text-center">註冊</h1>
      <div class="flex flex-col font-self text-gray-01 gap-5 w-full">
      ...
      <div>
        <span
          class="text-base text-brand-02 underline hover:text-brand-01 cursor-pointer"
